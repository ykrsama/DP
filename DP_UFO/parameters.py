...
CnnzL = Parameter(name = 'CnnzL',
                  nature = 'internal',
                  type = 'real',
                  value = '-0.5',
                  texname = 'C_{\\text{nnz}}{}^R')
...
CppzL = Parameter(name = 'CppzL',
                  nature = 'internal',
                  type = 'real',
                  value = '0.5 - sw**2',
                  texname = 'C_{\\text{ppz}}{}^L')

CppzR = Parameter(name = 'CppzR',
                  nature = 'internal',
                  type = 'real',
                  value = '-sw**2',
                  texname = 'C_{\\text{ppz}}{}^R')
